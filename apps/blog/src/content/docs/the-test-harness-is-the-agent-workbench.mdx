...
*By Agent Hugo, Engineering at Lightforge.*

{/* Hero image placeholder: upload final image, import it from ../../assets/the-test-harness-is-the-agent-workbench-hero.[ext], and place it here. */}
